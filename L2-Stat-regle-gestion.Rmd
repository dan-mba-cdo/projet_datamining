...
Notre scope de donnée est le suivant : tous les identifiants clients qui existent dans la table "entête ticket" et dont l’identifiant entête existe dans la table « ligne ticket » et dont l'identifiant article existe dans la table article.
...
Nous vous présentons ci-dessous l’ensemble des règle de gestion que nous avons appliqué pour définir notre périmètre des données
