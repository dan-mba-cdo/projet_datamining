...
Nous avons identifie 130 doublons.
  ...
  + On recupere uniquement les informations reliees entre elles : A Savoir uniquement les clients qui ont un entete ticket, lui meme rattache à une ligne ticket, et dont l'article est reference. Condition à respecter --  "inner join" entre les tables 
...
```
  + Nous constatons que l'IDARTICLE "395460" n'existe pas dans la table article et qu'il y a 31 lignes ticket lie à ce dernier, il faut donc le rajouter :
